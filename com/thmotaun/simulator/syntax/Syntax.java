package com.thmotaun.simulator.syntax;
...
public class Syntax {
    ...
    private void successMessage() {
        System.out.println("Syntax Notification: Successfully read ["+ this.filename +"].");
        System.out.println("Scanning ["+ this.filename +"] For Syntax Errors...\n");
    }
    ...
    private void readFileIntoString() {
        try (BufferedReader bufferReader = new BufferedReader(new FileReader(this.filename)))
        {
            ...
            System.out.println("Read Error (readFileIntoString): Cannot read file content.\nClosing program.");
            System.exit(0);
        } 
    }
        ...
        for (int lineNumber = 0; lineNumber < this.fileContent.size(); lineNumber++) {
            ...
            while ((currentLine.equals("")) || (currentLine.charAt(0) == '#')) {
                ...
                try {
                    ...
                    System.out.println("Syntax Error (validSyntax): Error checking line content.\nClosing program.");
                    System.exit(0);
                }
            }
            ...
            if (isFirstline == 1) {
                ...
                try {
                    ...
                    System.out.println("Syntax Error (validSyntax): Loop counter larger than integer maximum, setting counter to maximum - 1.\n");
                ...
                if (words.length > 5) {
                    System.out.println("Syntax Notification (validSyntax): Current read line has too many values.\nSkipping...\n");
                    notCorrect = true;
                } else if (words.length < 5) {
                    System.out.println("Syntax Notification (validSyntax): Current read line has too few values.\nSkipping...\n");
                    notCorrect = true;
                } else {
                    words = currentLine.split("\\s");
                    wordType = words[0];
                    ...
                    try {
                        if (wordOne.matches("^[0-9]*$")) {
                            ...
                            System.out.println("Syntax Error (validSyntax): Error found, incorrect longitude value for aircraft "+ type +" "+ name +".\nClosing program...\n");
                            System.exit(0);
                        }
                    } catch (Exception exception) {
                       // notCorrect = true;
                       // this.longitude = "";
                        ...
                        if (wordTwo.matches("^[0-9]*$")) {
                            ...
                            System.out.println("Syntax Error (validSyntax): Error found, incorrect latitude value for aircraft "+ type +" "+ name +".\nClosing program...\n");
                            System.exit(0);
                        }
                    } catch (Exception exception) {
                       // notCorrect = true;
                      //  this.latitude = "";
                        ...
                        if (wordThree.matches("^[0-9]*$")) {
                            ...
                            System.out.println("Syntax Error (validSyntax): Error found, incorrect height value for aircraft "+ type +" "+ name +".\nClosing program...\n");
                            System.exit(0);
                        }
                    } catch (Exception exception) {
                       // notCorrect = true;
            ...
            try {
                ...
                System.out.println("Syntax Error (validSyntax): Error creating list.\nClosing program...");
                System.exit(0);
            }
            flushVariables();
        }
    ...
    public ArrayList<Map<String, String>> getFileContent() {
        if (this.fileMapped.size() > 0) {
            System.out.println("Syntax Notification (getFileContent): List successfully populated.\n");
            return (this.fileMapped);
        } else {
            System.out.println("Syntax Error (getFileContent): List returned empty.\nClosing program...\n");
            System.exit(0);
        }
        return null;
    }
    ...
    public void CheckEmptyFile() {
        ...
        try {
            if (file.exists()) {
                try {
                    if (file.length() == 0) {
                        System.out.println("Syntax Error (CheckEmptyFile): File is empty.\nClosing program...\n");
                        System.exit(0);
                    } else {
                        readFileIntoString();
                    }
                ...
                System.out.println("Syntax Error (CheckEmptyFile): File does not exist.\nClosing program...\n");
                System.exit(0);
            }
        } catch (Exception e) { }
    }
